...
public class AccountView {
    public static void main(Scanner scan) {
        ...
        while(true){
            System.out.println("[Account] 0.Exit, 1.Create, 2.Withdraw, 3.Deposit, 4.Balance, 5.Delete, -1.List");
            switch (scan.next()){
                ...
                case "-1" : System.out.println(accountController.getAccountsList());    break;
