    ...
    public static void main(Scanner scan) {
        ...
        while(true){
            ...
            switch (scan.next()){
                ...
                case "3" :               break;
                case "4" :  userController.getUserByUsername(); break;
                case "5" :  userController.deleteUser();        break;
                case "6" :  userController.getUserMap();                            break;
                case "7" :  userController.findUsersByName();   break;
                case "8" :  userController.findUsersByJob();    break;
